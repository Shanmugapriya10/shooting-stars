...
<!-- Sidenav/menu -->
<nav class="w3-sidenav w3-white" style="z-index:3;width:250px" id="mySidenav">
  <div class="w3-container ">
    <i onclick="w3_close()" class="fa fa-remove w3-hide-large w3-closebtn w3-hover-text-red"></i>
    <h3 STYLE="FONT-FAMILY:JOKERMAN"><b>PRODUCTS LIST</b></h3>
  </div>
  <br/>
...
<header class="w3-container  w3-hide-large w3-black w3-xlarge w3-padding-24">
  <span class="w3-left w3-wide">PRODUCTS LIST</span>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <header class="w3-container w3-xlarge">
    <p class="w3-left">Action Figure Toys</p>
    <p class="w3-right">
  ...
  <div class="w3-container w3-text-grey" id="Action figure toys">
    <p>8 items</p>
  </div>
